...
面向产品、安全支持和工程人员的独立内部 Web 控制台。它不迁移或替代家长使用的微信小程序：主界面负责支持工单、运营判断、发布前规则验证和 AI 质量，技术作品集与合成变更场景集中在开发者专区。
...
- **家庭支持**：处理家长明确授权提交的 metadata-only 工单，支持认领、升级、安全复核、解决、关闭和审计；后台没有代替家长修改永久过敏档案的入口。
