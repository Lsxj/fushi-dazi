...
5. Add negative-path tests before happy-path tests. Include blocked unsafe food, missing consent, invalid state transition, missing audit record, and mutation rollback when relevant.
