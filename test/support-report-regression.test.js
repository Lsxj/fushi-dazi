...
assert.strictEqual(getSupportStatusLabel('new'), '待处理')
assert.strictEqual(getSupportStatusLabel('closed'), '已关闭')
assert.strictEqual(getSupportStatusLabel('unexpected'), '状态未知')
